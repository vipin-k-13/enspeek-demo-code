...
const PromptsList = () => {
  ...
  return [
    ...
    },
    {
      ...
      onClick: () =>
        dispatch(setMessage("generate [number] questions related to [topic]")),
    },
    {
    ...
    },
    {
      ...
      icon: <LuMove className="h-4 w-4" />,
      onClick: () =>
        dispatch(setMessage("move [question no] to [position example:- top, bottom]")),
    },
    {
    ...
    },
    {
      ...
      icon: <LuChartBar className="h-4 w-4" />,
      onClick: () =>
        dispatch(setMessage("Get count of completed surveys in [study name]")),
    },
    {
      ...
      icon: <LuChartBar className="h-4 w-4" />,
      onClick: () =>
        dispatch(setMessage("Get count of incompleted surveys in [study name]")),
    },
  ];
};
